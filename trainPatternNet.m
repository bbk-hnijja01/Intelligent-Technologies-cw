...
function [trainedNet, testRes, c, cm, netInputs, netTargets]  = ...
    trainPatternNet(trainingData, hiddenLayerNodes, trainingFunc, initWeights)
% trainPatternNet Creates and trains a feed forward net.
%
...
net = patternnet(hiddenLayerNodes, trainingFunc);

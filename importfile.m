function dataset = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   DATASET = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
...
%
% Example:
%   dataset = importfile('1trn.txt', 1, 300);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/01/05 11:02:37
